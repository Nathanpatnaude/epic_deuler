  ...
  console.log(Math.floor(2.5));
    ...
    return (
      ...
      <h1 className="fromtop title has-text-centered is-size-2 mb-4 equip" style={{ backgroundColor: '#e6cc80', textShadow: '2px 2px 10px #a335ee', display: 'inline-block', fontSize: '33px', borderRadius: '60px', boxShadow: ' 0 0 8px #999', padding: '0.5em 0.6em', margin:'0px', borderBottom: '16px', borderBottomStyle: 'solid'}}><span className='span-outline'>⚔️</span></h1>
        ...
        <div className='m-0'>
             <ListGroup  className="is-flex section field label box has-text-centered px-0 py-2 is-flex-wrap-wrap" style={{ border: '4px solid rgba(1, 1, 1, 1)', borderRadius: '40px', fontSize: '33px'}}>
                        
                 {sortOpponents(opponentData).map((opponent) => (
                   
                           
                   <div className={`dropdown pr-0 m-1 has-text-centered is-block`} key={opponent.name} style={opponentStyle(opponent.rating, dataMe.me.rating)}>
