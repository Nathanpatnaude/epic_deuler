        ...
        <div className="columns is-centered">
          <div className="column is-6">
            <div className="box has-text-centered" style={{ backgroundColor: '#ffffff' }}>
              <h1 className="title has-text-centered is-size-2 mb-4 equip" 
              ...
              <div className="buttons is-centered">
                <Link to="/login" className="button is-primary is-size-3 is-size-5-mobile" style={{ color: 'black', textShadow: '2px 2px 10px #ffffff', borderRadius: '40px', borderBottom: '8px', borderBottomStyle: 'solid' }}>✅
                  Login
                </Link>
